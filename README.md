...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9efca757-2fc4-4cbf-a777-c51a2c6d7bcf
```

> `9efca757-2fc4-4cbf-a777-c51a2c6d7bcf` is the password of the certificate, you can change it to any password you want.
